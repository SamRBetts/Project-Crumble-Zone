...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        pressure_baro_graph = TelemetryGraph("Pressure", time, example_data, "Pressure (Pa)")
        main_layout_bottom.addWidget(pressure_baro_graph,1,0)
        lat_GPS_graph = TelemetryGraph("Latitude",time, example_data, "Latitude (xxx.xx)")
        main_layout_bottom.addWidget(lat_GPS_graph, 2,0)
        speed_pitot_graph = TelemetryGraph("Air Speed",time, example_data, "speed (m/s)")
        ...
        long_GPS_graph = TelemetryGraph("Longitude",time, example2_data, "Longitude (xxx.xx)")
